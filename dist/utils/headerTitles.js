...
exports.TITLES = {
    ...
    SIGNUP_WELCOME_SUB_TITLE_TEXT: "A $piccioli is a donation app and used to collect donations and volunteer information for a charitable cause",
    ...
    SEND_VERIFICATION_CODE_TEXT: "We'll send a code to this email to verify your sign in",
    ...
    YOUR_NAME_SUB_TITLE_TEXT: "This will be the name you will use on your account",
    ...
    PERMISSIONS_DESCRIPTION_TEXT: "&piccioli work best with access to the following permissions",
    ...
    RESET_PASSWORD_SCREEN_SUB_TITLE_TEXT: "For security reasons, we’ll send you a verification code to your email.",
    SEND_CODE_BUTON_TEXT: "Send code",
    RESET_PASSWORD_SCREEN_ALERT_TEXT: "If you don't have access to this email please contact $piccioli support",
    CHECK_YOUR_EMAIL_SCREEN_TITLE_TEXT: "Check your email",
    CHECK_YOUR_EMAIL_SCREEN_SUB_TITLE_TEXT: "We've sent a 6 digit code to: {email}",
