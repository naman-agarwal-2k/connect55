...
exports.ERROR = {
    ...
    ACCOUNT_DEACTIVATED: {
        statusCode: 403,
        customMessage: "Your account has been deactivated, Please coordinate with admin.",
        type: "ACCOUNT_DEACTIVATED",
    },
    ACCOUNT_DELETED: {
        statusCode: 410,
        customMessage: "Your account has been deleted, Please coordinate with admin.",
    ...
    PROFILE_INCOMPLETE: {
        statusCode: 404,
        customMessage: "To proceed with generating your personalized QR code, we kindly request that you complete your profile information.",
...
exports.SUCCESS = {
    ...
    SEND_VERIFIATION_OTP: {
        statusCode: 200,
        customMessage: "We have successfully send a verification OTP on your email.",
